...
The prototypes will then be user tested through usability testing and co-dessign sessions. Both users with knowledge of the project and user without prior knowledge of the system should participate in the system in order to not bias results. 
