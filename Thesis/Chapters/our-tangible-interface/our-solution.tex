...
In addition to all of the above, we need to develop a framework which can be used for basic asthma operations, like starting treatments, receiving credits, etc. As the design should be highly modifiable, these basic operations should be identical across the two platforms.    
