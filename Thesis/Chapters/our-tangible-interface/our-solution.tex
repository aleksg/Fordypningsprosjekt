...
\begin{figure}[H] 
	\centering
		\includegraphics[width=0.8\paperwidth]{Pictures/rpi-arch-overview.png}
...
The RFID reader we used was a Sparkfun ID-12LA \iref{}. One of the requirements of the USB reader was that it should be able to connect through an USB-port. Thus one of our two USB-ports were sacrificed (see Table \ref{tab:pi-specs}). 
...
The alternative is if children need to take their medicine by need. If they need to take a medicine by need, they simply register their RFID-tag before children are taken through a quicker process (see Manuscript \iref{}).  
