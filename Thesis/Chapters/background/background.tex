...
\begin{figure}[H]
	\begin{minipage}[t]{0.3\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/capp_start_treatment.png}}
		\caption{\\Starting a \\treatment}
		\label{fig:capp_start_treatment}
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/capp_stars.png}}
		\caption{Inside the treasure chest}
		\label{fig:capp_stars}
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}	
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/capp_main_menu.png}}
...
\begin{figure}[H]
	\begin{minipage}[b]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/instructions-1.png}}
		\caption{\\ Instructions part 1}
		\label{fig:instructions-1}
	\end{minipage}
	\begin{minipage}[b]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/instructions-2.png}}
		\caption{\\ Instructions part 2}
		\label{fig:instructions-2}
	\end{minipage}
	\begin{minipage}[b]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/instructions-3.png}}
	...
	\begin{minipage}[b]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/instructions-4.png}}
		\caption{\\ Instructions part 4}
		\label{fig:instructions-4}
	\end{minipage}
	\begin{minipage}[b]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/instructions-5.png}}
		\caption{\\ Instructions part 5}
		\label{fig:instructions-5}
	\end{minipage}
	\begin{minipage}[b]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/instructions-6.png}}
	...
	\begin{minipage}[b]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/instructions-7.png}}
...
\begin{figure}[H]
	\begin{minipage}[t]{0.3\linewidth}
	\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/gapp_main_menu.png}}
	...
	\begin{minipage}[t]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/register_treatment_old.png}}
	...
	\begin{minipage}[t]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/gapp_view_plans.png}}
		\caption{View plans}
...
\begin{minipage}[b]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/information-1.png}}
	...
	\begin{minipage}[b]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/information-2.png}}
	...
	\begin{minipage}[b]{0.3\linewidth}
		\centering
		\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/app-screenshots/logg.png}}
