...
\begin{figure}[H]
	\begin{minipage}[b]{0.4\linewidth}
		...
		\caption{Karotz\fnurl{Image source: Karotz.com}{www.karotz.com}}
		\label{fig:karotz}
	\end{minipage}
	\hspace{3cm}
	\begin{minipage}[b]{0.4\linewidth}
