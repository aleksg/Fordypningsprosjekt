...
Regarding the development of AsthmAPP, we will focus mainly on the gamification aspect during the codesign sessions. The test persons will be asked to test out the application at home, and give feedback on how the test went. The first version of AsthmAPP has a very open and user-controlled system for the rewards (see Section \ref{sec:gamificationinapp}). While this is an idea we consider appropriate initially, this may change based on user experience and feedback. The reward system using stars will also need testing, since we have little knowledge of how this is percieved by children over time.
