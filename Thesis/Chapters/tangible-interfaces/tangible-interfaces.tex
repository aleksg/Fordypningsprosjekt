...
For instance, a system that is capable of reading RFID-tags is a Token + Constraint system. The RFID-tag is considered a token, while the area the RFID scanner can read from is considered as a constraint.  
