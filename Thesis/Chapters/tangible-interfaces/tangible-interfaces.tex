...
This chapter will introduce the reader to \emph{tangible user interfaces}, and elaborate on some existing research that has been done on the concept. Finally the chapter will plan how we intend to make our tangible user interface.   
...
We consider Question \textbf{OC5b} as irrelevant for our purposes, as we will have a stationary artefact without any electromechanical and phyical ergonomic properties, i.e. moving arms, waving ears, etc. As far as questions \textbf{FC7} and \textbf{FC8} goes, we consider these irrelevant. These questions assumes that the tangible interface developed is performing a task for the user, which is not a part of our system. The remaining questions are considered relevant, and will be discussed in Section \ref{sec:answeringchampoux}.     
