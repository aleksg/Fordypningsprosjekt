...
After inserting these parameters, the LogicHandler retrieves a \code{LinkedList} of Interactions that is to be played. After this sequence is ended, the system jumps to \ref{fig:ab-sd-instructions}.
