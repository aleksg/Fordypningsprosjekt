...
After inserting these parameters, the \code{LogicHandler} retrieves a LinkedList of \code{Interaction}-objects that is to be played. After this sequence is ended, the system jumps to \ref{fig:ab-sd-instructions}.
