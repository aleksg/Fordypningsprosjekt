...
\begin{table}[h]
	\begin{tabular}{| p{2.5cm} | p{4.0cm} | p{6.7cm} |}
	\hline
	\textbf{Category} & \textbf{Question} & \textbf{Answer} \\
	\hline
	\textbf{Defining the Boundaries} & \textbf{BO1} What should the user experience? & Answer \\
	\cline{2-3}
	 & \textbf{BO2} What are the human tasks? & Answer \\
	\cline{2-3}
	 & \textbf{BO3} What should the artefact represent and control? & Answer \\
	\cline{2-3}
	 & \textbf{BO4} What are the conventions (Physical ergonomics vs electromechanical)? & Answer \\
	\hline
	\textbf{Orienting the Concepts} & \textbf{OC5a} What is the nature of the interaction for each sub task (Continuous vs Discrete vs Assembly)? & Answer \\
	\cline{2-3}
	 & \textbf{OC6} Does the sub-task need any relational interaction? & Answer \\
	\hline
	\textbf{Fitting the Components} & \textbf{FC7} What are the relations between the objects and the actions? & Answer \\
	\cline{2-3}
	 & \textbf{FC8} What is the task order when using the artefact? & Answer \\
	\hline	
	\end{tabular}
	\caption{Something useful}
	\label{tab:answeringchampoux}
\end{table}  
