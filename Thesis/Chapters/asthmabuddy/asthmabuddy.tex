...
Children must have their inhaler and breathing chamber stored within a short distance of \buddy{}. Their RFID-tags are attached to their inhalers.    
...
[TODO Pieter: Vil RFID-tag og RFID-leser her telle som en form for relational interaction?]
...
\ab{} also supports telling the user how many stars is collected without having to go through a treatment first. By running a program named \emph{stars.sh} on \ab{}, the system listens for RFID input. If a RFID reading is registered, the system connects to the database and plays a sound telling the user how many stars he/she has collected.
