...
\paragraph{Feedback}
Some of the feedback we got reagards the by need treatments. Some parents claimed that they would not use \buddy{} to complete a by need treatment, as their child was suffering from an asthma attack. However, one of the parent noted that if children were used to perform their treatment with \buddy{}, it could create a dependency toward it, i.e. \buddy{} could help the child calm down. Whether or not this is a functionality that actually would be used needs more research, as \buddy{} would need to be placed within a home and be nearby when such an attack occurs. 
