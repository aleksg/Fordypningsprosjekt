...
\begin{figure}[H] 
	...
	\begin{minipage}[b]{0.4\linewidth}
		...
		\caption{AsthmaBuddy with his nose light turned on\footnote{The bear was bought from www.bemybear.com, since their kits suited our needs.}}
...
\ab{} 2.0 now syncs achieved stars automatically between \app{} and \ab{}. This was done to automate some tasks that previously needed manual interaction, and to create a tighter coupling between the two prototypes. 
