...
While designing AsthmAPP, we strived for an easy-to-use design with a good overview, in addition to the Android Design Principles\cite{androiddesign}. In chapter \ref{chp:usability} we described usability and general terms every designer should consider. We have especially taken Shneidermann's eight golden rules into consideration when designing\cite{shneiderman2003designing} \app{}. 
...
What happens if a child need his/her medicine, but the application or our TUI is not nearby? The child would probably be disappointed because they did not get their star, and did he/she did not get a star. Fortunately, it is possible to register a medicine afterwards, which entitles the child the amount of stars he/she should have received. \emph{Register Treatment} allows parents to register the medicine on any given day prior to current time (See Figure \ref{fig:register_medicine_taken}).  
