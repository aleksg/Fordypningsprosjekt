...
\begin{figure}
		\centering
			\fbox{\includegraphics[width=0.60\paperwidth]{Pictures/system-architecture.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.25\paperwidth]{Pictures/app-screenshots/asthmapp-main-menu.png}}
...
\begin{figure}
	\begin{minipage}[t]{0.3\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/kid-menu.png}}
	...
	\begin{minipage}[t]{0.3\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/child-possible-rewards.png}}
	...
	\begin{minipage}[t]{0.3\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/child-bought-reward.png}}
...
\begin{figure}
	\begin{minipage}[t]{0.4\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/parent-menu.png}}
	...
	\begin{minipage}[t]{0.4\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/medicine-plans.png}}
	...
	\begin{minipage}[t]{0.4\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/add-medicine-to-plan.png}}
	...
	\hspace{3cm}
		\begin{minipage}[t]{0.4\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/register-medicine-taken.png}}
	...
	%NEW LINE
		\begin{minipage}[t]{0.4\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/log.png}}
	...
	\hspace{3cm}
		\begin{minipage}[t]{0.4\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/award.png}}
...
\begin{figure}
	\begin{minipage}[t]{0.4\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/create-award.png}}
	...
	\end{minipage}
	 ...
	 \begin{minipage}[t]{0.4\linewidth}
		\centering
			\fbox{\includegraphics[width=0.20\paperwidth]{Pictures/new-screenshots/pin-challenge.png}}
