...
\begin{figure}
	\begin{minipage}[t]{0.4\linewidth}
		...
		\caption{RGB LED diagram. \fnurl{Image source: courses.cs.purdue.edu}{http://courses.cs.purdue.edu/cs25000:lab3}}
		\label{fig:rgb-led}
	\end{minipage}
	\hspace{1cm}
	\begin{minipage}[t]{0.4\linewidth}
		...
		\caption{\rpi{} GPIO. \fnurl{Image source: elinux.org}{http://elinux.org/File:GPIOs.png}}
		\label{fig:rpigpio}
	\end{minipage}
\end{figure}
